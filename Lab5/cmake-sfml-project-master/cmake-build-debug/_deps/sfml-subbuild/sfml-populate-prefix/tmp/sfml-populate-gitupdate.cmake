...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" show-ref "2.6.x"
  WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" fetch --tags --force "origin"
    WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" symbolic-ref -q HEAD
    WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
...
execute_process(
  COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" status --porcelain
  WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" checkout "${checkout_name}"
    WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" rebase "${checkout_name}"
    WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" rebase --abort
      WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" stash pop --index --quiet
          WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src'."
    ...
    execute_process(
      COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" reset --hard --quiet
      WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
    )
    execute_process(
      COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" stash pop --quiet
      WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
      )
      execute_process(
        COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/Users/gongkaiwen/opt/miniconda3/bin/git" submodule update --recursive --init 
    WORKING_DIRECTORY "/Users/gongkaiwen/Desktop/研究生/第一学期/ece 6122/lab/Lab5/cmake-sfml-project-master/cmake-build-debug/_deps/sfml-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
